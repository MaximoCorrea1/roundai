...
| 5 | **La historia, en orden** | The coach tells the 5-beat story, each number feeding the next: ① "cada compra se redondea un **3,5%** para arriba" ② "gastás **$ 1.180.000**/mes → invertís **$ 41.667**/mes" ③ "te sobran ~$ 108.333 ($ 1.450.000 − $ 1.180.000): entra cómodo" ④ "en 12 meses aportás ~$ 500.000 → con retorno esperado ~**$ 588.543** (+$ 88.543 · simulado)" ⑤ "la alcanzás en ~**11 meses** contando retorno (12 sin · 10–12 según mercado)" + the **chain card** (compra → gastos → inversión → FCI → retorno). | "Mecanismo, gastos, inversión, retorno, plan — una sola historia donde cada número alimenta el siguiente." | 0:24 |
| 6 | **El margen se toca** ⭐ | Tap the lime **3,5%** chip → tweaker → step to **7%** → **Confirmar margen** → **THE WHOLE STORY RE-RENDERS**: café +$ 305 · invertís $ 82.600/mes · 12m ~$ 1.166.727 (+$ 175.527) · meta en ~**6 meses** contando retorno (7 sin). Accept "✦ Dale, activalo". | "Muevo UNA perilla y toda la historia se recalcula — el redondeo, la inversión mensual, el retorno y la fecha. Eso es transparencia." | 0:25 |
