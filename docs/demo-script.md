...
| 5 | **Propuesta que enseña** | Coach: tendencias direction-aware ("eso viene subiendo **+5,9%** / **+20,3%**") → **TUS NÚMEROS** card (ingresos − gastos → te queda ~$ 108.333 → margen = aporte ÷ gastos) → the **mechanism visual** (café $ 4.350 splitting → al comercio / ✦ +$ 154 a tu meta) → plan "**$ 41.667/mes, el 3,5%**" + anchor "de cada $ 100 que gastás, $ 4 van a tu meta" + **scenarios**: "Sin rendimientos: 12 meses. Con retorno esperado: ~11 (10–12 según mercado) · simulado, no garantizado." | "Sus números reales, el mecanismo en un dibujo, y la proyección CON retorno esperado — mejor, normal y peor caso. Todo simulado, nada prometido." | 0:22 |
| 6 | **El margen se toca** ⭐ | Tap the lime **3,5%** chip → tweaker (opens at the exact 3,5%): step to **7%** → "aporte **$ 82.600/mes** · llegás en **7 meses** · café suma **$ 305**" → **Confirmar margen** → proposal re-renders at 7% incl. "Con retorno esperado: **~6 meses**" → "✦ Dale, activalo". Activated: "cada pago redondea 7% a *La compu*. Probalo: volvé a la billetera y pagá el café." | "El margen no es caja negra: lo subo al tope de mi perfil — 7 meses en vez de 12, y ~6 con retorno esperado. Decido yo, informado." | 0:25 |
...
| 9 | **Mi meta** | Goal page "**La compu**": lo tuyo **$ 82.906** · te falta **$ 417.094** · "con ~**$ 82.601**/mes en redondeos, llegás en ~**6 meses**" → **LLEGÁS EN {mes año}** (returns-aware ETA, renders relative to demo day — on 2026-06-07 it read **Noviembre de 2026**) + range "✦ 5–5 meses según mercado · simulado" · "tu café de hoy te acercó **1 día** ✦" · Tu cartera: total $ 82.906, "a 12 meses ~**$ 1.166.741** ✦ simulado", reparto Moderado **55/30/15** · Otras metas: Viaje a Bariloche (simulada). | "El café se volvió un día menos, con fecha concreta — y la fecha ya descuenta el retorno esperado. La cartera se arma según SU perfil. Cada número se recalcula a mano desde el ledger." | 0:24 |
